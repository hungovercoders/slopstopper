...
│   └── pyproject.toml        # 0.2.1 Beta — install: `pipx install https://github.com/hungovercoders/slopstopper/releases/download/v0.2.1/slopstopper_cli-0.2.1-py3-none-any.whl`
