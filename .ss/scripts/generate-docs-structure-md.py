...
This script is used both locally (via 'task ss:hygiene:docs-structure') and in CI/CD.
...
{("✅ Documentation structure matches governance model" if is_valid else "❌ Documentation structure violations found")}
